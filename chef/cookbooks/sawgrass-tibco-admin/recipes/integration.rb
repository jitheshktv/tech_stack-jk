...
this_sg="#{node['createdomain-dbems']['config']['tibco_security_group_id']}"
rds_sg="#{node['createdomain-dbems']['config']['db_security_group']}"
rds_port="#{node['createdomain-dbems']['config']['db_port']}"
